# Laffey API Individual Contributor License Agreement (v1.0)

Thank you for your interest in contributing to Laffey API ("the Project"). This Contributor License Agreement ("Agreement") documents the rights granted by contributors to the Project.
...
- **"Project Owner"** means the maintainer of `desalahy/Sub2api_laffey`, or any individual or legal entity to whom that maintainer has explicitly assigned or transferred ownership of the Project in writing, and their respective successors and assigns.
