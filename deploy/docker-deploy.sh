#!/bin/bash
# =============================================================================
# Laffey API Docker Deployment Preparation Script
# =============================================================================
# This script prepares deployment files for Laffey API:
...
GITHUB_RAW_URL="https://raw.githubusercontent.com/desalahy/Sub2api_laffey/main/deploy"
...
main() {
    echo ""
    echo "=========================================="
    echo "  Laffey API Deployment Preparation"
    echo "=========================================="
    echo ""
