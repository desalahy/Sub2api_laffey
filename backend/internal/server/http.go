...
import (
	...
	"golang.org/x/net/http2/h2c" //nolint:staticcheck // SA1019: preserves configured h2c behavior until native Protocols migration is verified.
)
...
func ProvideHTTPServer(cfg *config.Config, router *gin.Engine) *http.Server {
	...
	if cfg.Server.H2C.Enabled {
		...
		httpHandler = h2c.NewHandler(router, &http2.Server{ //nolint:staticcheck // SA1019: see import rationale.
